...
class Profile extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            //projects count
            Container(
              decoration: BoxDecoration(color: Color(0x3F6600FF), borderRadius: BorderRadius.circular(15)),
            ...
            Container(
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: ()async{
                      launch('mailto:sup_program@hotmail.com');
                    },
                    child: Container(
                      color: color,
                      child: ListTile(
                  ...
                  GestureDetector(
                    onTap: () {
                      CoolAlert.show(
                          ...
                          confirmBtnText: 'Yes',
                          onConfirmBtnTap: () {
                            bool accountType = FirebaseAuth.instance.currentUser!.providerData[0].providerId == 'google.com';
                            Navigator.pop(context);
                            ...
                            showDialog(
                                    ...
                                    builder: (context) => AlertDialog(
                                          ...
                                          content: SizedBox(
                                            ...
                                            child: Column(
                                              children: [
                                                Text('If you are sure about deleting your account, click confirm button. You will lose all your information and your project.', softWrap: true,),
                                              ],
                                            ),
                                          ),
                                          actions: [
                            ...
                            showDialog(
                                ...
                                builder: (context) => AlertDialog(
                                      ...
                                      content: SizedBox(
                                        ...
                                        child: Column(
                                          children: [
                                            Text('Please enter your password to confirm the deletion.'),
                                            SizedBox(
                                              height: 90,
                                              child: Padding(
                                                ...
                                                child: Form(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    obscureText: false,
                                                    validator: (text){
                                                      FirebaseAuth.instance.signInWithEmailAndPassword(email: user!.email, password: password.text).then((value) => {
                                                      ...
                                                      if(!signInValidate)
                                                        return "Your password entered isn\'t validate";
                                                      else
                                                        return null;
                                                    },
                                                    decoration: InputDecoration(
  ...
  //This method for delete the user account
